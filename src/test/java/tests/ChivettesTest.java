...
public class ChivettesTest {
    ...
    @BeforeTest
    @Parameters({"chivetteEmail", "password", "url"})
    public void login(@Optional("thechivetest+chivette@gmail.com") String unpaidEmail, @Optional("Chive1234") String password, @Optional("https://qa.chive-testing.com") String url) throws InterruptedException {
        driver.get(url);
